...
<aside
  ...
  <div class="flex flex-col h-full">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
      ...
      <a href="/teacher_subjects/index.php"
        class="group flex items-center px-3 py-2 text-sm font-medium rounded-md <?= strpos($_SERVER['REQUEST_URI'], '/teacher_subjects/') !== false ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' ?> transition-colors">
        <svg class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
        </svg>
        Teacher Subjects
      ...
      <a href="/rooms/index.php"
        class="group flex items-center px-3 py-2 text-sm font-medium rounded-md <?= strpos($_SERVER['REQUEST_URI'], '/room/') !== false ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' ?> transition-colors">
        <svg class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
        </svg>
        Rooms
