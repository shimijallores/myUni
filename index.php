        ...
        <main class="pt-16 lg:pt-0">
            <div class="py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <a href="teacher_subjects/index.php" class="bg-white border border-gray-300 p-6 hover:border-neutral-800 transition-colors">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 bg-yellow-50 rounded-md p-3">
                                <svg class="h-6 w-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">Teacher Subjects</h3>
                                <p class="text-sm text-gray-600">Manage subjects</p>
                            </div>
                        </div>
                    </a>
                    ...
                    <!-- Rooms Card -->
                    <a href="rooms/index.php" class="bg-white border border-gray-300 p-6 hover:border-neutral-800 transition-colors">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 bg-purple-50 rounded-md p-3">
                                <svg class="h-6 w-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-600">Manage rooms</p>
                            </div>
                        </div>
                    </a>
